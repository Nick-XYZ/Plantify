    ...
    ('Chili', 'Capsicum annuum', 'Direct sunlight', 2, 5, 186, 'Chili can be planted all year around, but needs extra light in the winter. Chili can be pre-planted in march and needs to be repotted. It loves warm places and sunlight and needs protection from heavy wind.', 'Long desc'),
    ('Strawberries', 'Fragaria', 'Direct sunlight', 3, 5, 120, 'Strawberries can get planted in early in the spring and can be harvested between june and august.', 'Long desc'),
    ('Sweetpeas', 'Pisum sativum','Direct sunlight', 2, 5, 60, 'Sweetpeas is easy to handle. You should plant it with some weeks apart, because the plant have a short life and this extends the season. The more you harvest, the more the plant produces.', 'Long desc'),
    ('Cherry Tomatoes - Primagold', 'Solanum lycopersicum var. cerasiforme', 'Direct sunlight', 1, 5, 120, 'A bountiful, compact cherry tomato that does not need to be plucked or tied up. Produces sweet little tomatoes all summer long. Perfect for the balcony, terrace or in the kitchen window. Grow indoors.', 'Long desc'),
    ('Zucchini', 'Cucurbita pepo', 'Direct sunlight', 1, 5, 120, 'Zucchini can get planted in March or April and you can do the first harvest in july.', 'Long desc');
