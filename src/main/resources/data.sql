    ...
    ('Strawberries', 'Fragaria', 'Direct sunlight', 'Vegetable soil with cow manure', 14, 14, 14, 120, 'Strawberries can get planted early in the spring and can be harvested between June and August.');
